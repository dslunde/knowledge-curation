...
2. Go to your repository at [GitHub/knowledge-curator](https://github.com/GitHub/knowledge-curator).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `knowledge-curator.lundandco.net` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | knowledge-curator.lundandco.net | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | knowledge-curator.lundandco.net |
...
- [Backend Tests Workflow](https://github.com/GitHub/knowledge-curator/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/GitHub/knowledge-curator/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/GitHub/knowledge-curator-backend`) and Frontend (`ghcr.io/GitHub/knowledge-curator-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of knowledge-curator.lundandco.net](https://github.com/GitHub/knowledge-curator/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/knowledge-curator.lundandco.net.yml` stack.
