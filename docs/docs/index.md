...
myst:
  html_meta:
    ...
    "property=og:description": "A knowledge curation tool built on Plone."
    "property=og:title": "Knowledge Curator"
    "keywords": "Knowledge Curator, documentation, A knowledge curation tool built on Plone."
---

# Knowledge Curator

Welcome to the documentation for Knowledge Curator!
