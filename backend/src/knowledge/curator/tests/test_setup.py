...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.isProductInstalled("knowledge.curator"))
    ...
    def test_browserlayer(self):
        ...
        self.assertIn(IPloneAppKnowledgeLayer, utils.registered_layers())
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        self.assertFalse(self.installer.isProductInstalled("knowledge.curator"))
