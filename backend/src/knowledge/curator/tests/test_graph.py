...
from knowledge.curator.graph import (
    Graph, Node, Edge, NodeType,
    RelationshipType, RelationshipManager,
    GraphOperations, GraphAlgorithms,
    GraphStorage, GraphTraversal
)
    ...
    def test_add_content_node(self):
        ...
        self.assertTrue(
            self.ops.add_content_node(
                'uid1', 'Research Note 1', 'ResearchNote',
                tags=['python', 'testing']
            )
        )
...
class TestGraphStorage(unittest.TestCase):
    ...
    def test_save_and_load_graph(self):
        ...
        loaded_edge = loaded_graph.get_edge('test1', 'test2', RelationshipType.RELATED_TO.value)
    ...
    def test_query_nodes(self):
        ...
        for i in range(3):
            node = Node(f'note{i}', f'Note {i}', NodeType.RESEARCH_NOTE,
...
class TestGraphTraversal(unittest.TestCase):
    ...
    def test_suggest_next_nodes(self):
        ...
        for node, reason, score in suggestions:
