...
class TestForgettingCurve(unittest.TestCase):
    ...
    def test_analyze_learning_efficiency(self):
        ...
        history = [
            {'date': (datetime.now() - timedelta(days=10)).isoformat(), 'quality': 4, 'interval': 1},
            {'date': (datetime.now() - timedelta(days=9)).isoformat(), 'quality': 3, 'interval': 6},
            {'date': (datetime.now() - timedelta(days=3)).isoformat(), 'quality': 5, 'interval': 15},
        ]
...
class TestReviewScheduler(unittest.TestCase):
    ...
    def test_optimize_review_time(self):
        ...
        history = [
            {
                'date': (datetime.now().replace(hour=9) - timedelta(days=i)).isoformat(),
...
class TestPerformanceTracker(unittest.TestCase):
    ...
    def test_calculate_streaks(self):
        ...
        history = [
            ...
            {'date': (datetime.now() - timedelta(days=3)).isoformat(), 'quality': 2},  # Fail
