...
class TestSearchAPI(unittest.TestCase):
    ...
    def test_fulltext_search(self):
        ...
        response = self.api_session.post(
            "/@knowledge-search",
            json={"type": "fulltext", "query": "Python", "limit": 20},
        )
    ...
    def test_search_with_filters(self):
        ...
        response = self.api_session.post(
            ...
            json={
                "type": "fulltext",
                "query": "programming",
                "filters": {"tags": ["python"], "review_state": ["private"]},
            },
        )
    ...
    def test_search_with_date_filter(self):
        ...
        response = self.api_session.post(
            ...
            json={
                "type": "fulltext",
                "query": "programming",
                "filters": {"date_range": {"start": yesterday, "end": tomorrow}},
            },
        )
    ...
    def test_search_invalid_type(self):
        ...
        response = self.api_session.post(
            "/@knowledge-search", json={"type": "invalid", "query": "test"}
        )
    ...
    def test_search_missing_query(self):
        ...
        response = self.api_session.post(
            "/@knowledge-search", json={"type": "fulltext"}
        )
    ...
    def test_similarity_search_missing_uid(self):
        ...
        response = self.api_session.post(
            "/@knowledge-search", json={"type": "similarity", "limit": 5}
        )
    ...
    def test_similarity_search_invalid_uid(self):
        ...
        response = self.api_session.post(
            "/@knowledge-search",
            json={"type": "similarity", "uid": "invalid-uid", "limit": 5},
        )
    ...
    def test_search_limit(self):
        ...
        response = self.api_session.post(
            "/@knowledge-search",
            json={"type": "fulltext", "query": "programming", "limit": 2},
        )
