...
class Node:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            'uid': self.uid,
            'title': self.title,
            'type': self.node_type.value if isinstance(self.node_type, NodeType) else self.node_type,
...
class Graph:
    ...
    def get_edge(self, source_uid: str, target_uid: str, relationship_type: str) -> Optional[Edge]:
        """Get an edge by its endpoints and type."""
        return self.edge_index.get((source_uid, target_uid, relationship_type))
    
    def get_neighbors(self, uid: str, relationship_type: Optional[str] = None) -> List[str]:
    ...
    def get_incoming_neighbors(self, uid: str, relationship_type: Optional[str] = None) -> List[str]:
    ...
    def get_edges_from_node(self, uid: str, relationship_type: Optional[str] = None) -> List[Edge]:
    ...
    def get_edges_to_node(self, uid: str, relationship_type: Optional[str] = None) -> List[Edge]:
