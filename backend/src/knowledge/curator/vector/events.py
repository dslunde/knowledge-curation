...
from knowledge.curator.vector.config import (
    get_vector_config,
    SUPPORTED_CONTENT_TYPES,
    INDEXED_WORKFLOW_STATES
)
from knowledge.curator.vector.management import VectorCollectionManager
from zope.component import adapter
from zope.lifecycleevent import IObjectCreatedEvent, IObjectModifiedEvent, IObjectRemovedEvent
