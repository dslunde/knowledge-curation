...
class ReviewUtilities:
    ...
    def get_items_due_for_review(
        ...
        portal_types: Optional[List[str]] = None,
        ...
        for brain in brains:
            try:
                ...
                if obj.next_review is None or obj.next_review <= now:
                    ...
                    due_items.append({
                        ...
                        'sr_data': {
                            ...
                            'next_review': obj.next_review.isoformat() if obj.next_review else None,
                ...
                print(f"Error processing item {brain.UID}: {str(e)}")
                continue
    ...
    def get_adaptive_schedule(
        ...
        for i in range(7):
            ...
            day_items = [
                ...
                if item['sr_data'].get('next_review') and
                item['sr_data']['next_review'].date() == date
            ]
